...
void CtpTd::OnRspUserAuthMethod(CThostFtdcRspUserAuthMethodField *pRspUserAuthMethod, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	Task *task = new Task();
	task->name = ON_RSP_USER_AUTH_METHOD;
	if (pRspUserAuthMethod)
		task->payload = RspUserAuthMethodField(*pRspUserAuthMethod);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
	task->num = nRequestID;
	task->final = bIsLast;
...
void CtpTd::OnRspGenUserCaptcha(CThostFtdcRspGenUserCaptchaField *pRspGenUserCaptcha, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	Task *task = new Task();
	task->name = ON_RSP_GEN_USER_CAPTCHA;
	if (pRspGenUserCaptcha)
		task->payload = RspGenUserCaptchaField(*pRspGenUserCaptcha);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
	task->num = nRequestID;
	task->final = bIsLast;
...
void CtpTd::OnRspGenUserText(CThostFtdcRspGenUserTextField *pRspGenUserText, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	Task *task = new Task();
	task->name = ON_RSP_GEN_USER_TEXT;
	if (pRspGenUserText)
		task->payload = RspGenUserTextField(*pRspGenUserText);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
	task->num = nRequestID;
	task->final = bIsLast;
...
void CtpTd::OnRspOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	Task *task = new Task();
	task->name = ON_RSP_OPTION_SELF_CLOSE_INSERT;
	if (pInputOptionSelfClose)
		task->payload = InputOptionSelfCloseField(*pInputOptionSelfClose);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
	task->num = nRequestID;
	task->final = bIsLast;
...
void CtpTd::OnRspOptionSelfCloseAction(CThostFtdcInputOptionSelfCloseActionField *pInputOptionSelfCloseAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	Task *task = new Task();
	task->name = ON_RSP_OPTION_SELF_CLOSE_ACTION;
	if (pInputOptionSelfCloseAction)
		task->payload = InputOptionSelfCloseActionField(*pInputOptionSelfCloseAction);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
	task->num = nRequestID;
	task->final = bIsLast;
...
void CtpTd::OnRspQrySecAgentTradingAccount(CThostFtdcTradingAccountField *pTradingAccount, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	Task *task = new Task();
	task->name = ON_RSP_QRY_SEC_AGENT_TRADING_ACCOUNT;
	if (pTradingAccount)
		task->payload = TradingAccountField(*pTradingAccount);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
...
void CtpTd::OnRspQrySecAgentCheckMode(CThostFtdcSecAgentCheckModeField *pSecAgentCheckMode, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	Task *task = new Task();
	task->name = ON_RSP_QRY_SEC_AGENT_CHECK_MODE;
	if (pSecAgentCheckMode)
		task->payload = SecAgentCheckModeField(*pSecAgentCheckMode);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
	task->num = nRequestID;
	task->final = bIsLast;
...
void CtpTd::OnRspQrySecAgentTradeInfo(CThostFtdcSecAgentTradeInfoField *pSecAgentTradeInfo, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	Task *task = new Task();
	task->name = ON_RSP_QRY_SEC_AGENT_TRADE_INFO;
	if (pSecAgentTradeInfo)
		task->payload = SecAgentTradeInfoField(*pSecAgentTradeInfo);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
	task->num = nRequestID;
	task->final = bIsLast;
...
void CtpTd::OnRspQryOptionSelfClose(CThostFtdcOptionSelfCloseField *pOptionSelfClose, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	Task *task = new Task();
	task->name = ON_RSP_QRY_OPTION_SELF_CLOSE;
	if (pOptionSelfClose)
		task->payload = OptionSelfCloseField(*pOptionSelfClose);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
	task->num = nRequestID;
	task->final = bIsLast;
...
void CtpTd::OnRspQryInvestUnit(CThostFtdcInvestUnitField *pInvestUnit, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	Task *task = new Task();
	task->name = ON_RSP_QRY_INVEST_UNIT;
	if (pInvestUnit)
		task->payload = InvestUnitField(*pInvestUnit);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
	task->num = nRequestID;
	task->final = bIsLast;
...
void CtpTd::OnRtnOptionSelfClose(CThostFtdcOptionSelfCloseField *pOptionSelfClose) {
	Task *task = new Task();
	task->name = ON_RTN_OPTION_SELF_CLOSE;
	if (pOptionSelfClose)
		task->payload = OptionSelfCloseField(*pOptionSelfClose);
	this->task_queue.push(task);
}

void CtpTd::OnErrRtnOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose, CThostFtdcRspInfoField *pRspInfo) {
	Task *task = new Task();
	task->name = ON_ERR_RTN_OPTION_SELF_CLOSE_INSERT;
	if (pInputOptionSelfClose)
		task->payload = InputOptionSelfCloseField(*pInputOptionSelfClose);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
...
void CtpTd::OnErrRtnOptionSelfCloseAction(CThostFtdcOptionSelfCloseActionField *pOptionSelfCloseAction, CThostFtdcRspInfoField *pRspInfo) {
	Task *task = new Task();
	task->name = ON_ERR_RTN_OPTION_SELF_CLOSE_ACTION;
	if (pOptionSelfCloseAction)
		task->payload = OptionSelfCloseActionField(*pOptionSelfCloseAction);
	if (pRspInfo)
		task->resp = RspInfoField(*pRspInfo);
	this->task_queue.push(task);
}
...
void CtpTd::processTask() {
    while (true) {
        ...
        switch (task->name) {
			...
			case ON_RSP_USER_AUTH_METHOD: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<RspUserAuthMethodField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onRspUserAuthMethod(const_cast<object &>(payload), const_cast<object &>(resp), task->num, task->final);
				break;
			}
			case ON_RSP_GEN_USER_CAPTCHA: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<RspGenUserCaptchaField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onRspGenUserCaptcha(const_cast<object &>(payload), const_cast<object &>(resp), task->num, task->final);
				break;
			}
			case ON_RSP_GEN_USER_TEXT: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<RspGenUserTextField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onRspGenUserText(const_cast<object &>(payload), const_cast<object &>(resp), task->num, task->final);
				break;
			}
			...
			case ON_RSP_OPTION_SELF_CLOSE_INSERT: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<InputOptionSelfCloseField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onRspOptionSelfCloseInsert(const_cast<object &>(payload), const_cast<object &>(resp), task->num, task->final);
				break;
			}
			case ON_RSP_OPTION_SELF_CLOSE_ACTION: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<InputOptionSelfCloseActionField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onRspOptionSelfCloseAction(const_cast<object &>(payload), const_cast<object &>(resp), task->num, task->final);
				break;
			}
			...
			case ON_RSP_QRY_SEC_AGENT_TRADING_ACCOUNT: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<TradingAccountField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onRspQrySecAgentTradingAccount(const_cast<object &>(payload), const_cast<object &>(resp), task->num, task->final);
				break;
			}
			case ON_RSP_QRY_SEC_AGENT_CHECK_MODE: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<SecAgentCheckModeField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onRspQrySecAgentCheckMode(const_cast<object &>(payload), const_cast<object &>(resp), task->num, task->final);
				break;
			}
			case ON_RSP_QRY_SEC_AGENT_TRADE_INFO: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<SecAgentTradeInfoField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onRspQrySecAgentTradeInfo(const_cast<object &>(payload), const_cast<object &>(resp), task->num, task->final);
				break;
			}
			...
			case ON_RSP_QRY_OPTION_SELF_CLOSE: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<OptionSelfCloseField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onRspQryOptionSelfClose(const_cast<object &>(payload), const_cast<object &>(resp), task->num, task->final);
				break;
			}
			case ON_RSP_QRY_INVEST_UNIT: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<InvestUnitField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onRspQryInvestUnit(const_cast<object &>(payload), const_cast<object &>(resp), task->num, task->final);
				break;
			}
			...
			case ON_RTN_OPTION_SELF_CLOSE: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<OptionSelfCloseField &>(task->payload));
				this->onRtnOptionSelfClose(const_cast<object &>(payload));
				break;
			}
			case ON_ERR_RTN_OPTION_SELF_CLOSE_INSERT: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<InputOptionSelfCloseField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onErrRtnOptionSelfCloseInsert(const_cast<object &>(payload), const_cast<object &>(resp));
				break;
			}
			case ON_ERR_RTN_OPTION_SELF_CLOSE_ACTION: {
				const object &payload = task->payload.empty() ? object() : object(any_cast<OptionSelfCloseActionField &>(task->payload));
				const object &resp = task->resp.empty() ? object() : object(any_cast<RspInfoField &>(task->resp));
				this->onErrRtnOptionSelfCloseAction(const_cast<object &>(payload), const_cast<object &>(resp));
				break;
			}
...
void CtpTd::registerFensUserInfo(boost::python::object &fensUserInfoField) {
...
int CtpTd::reqAuthenticate(boost::python::object &reqAuthenticateField, int requestId) {
	ReqAuthenticateField *p1 = extract<ReqAuthenticateField *>(reqAuthenticateField);
	return this->api->ReqAuthenticate(p1, requestId);
}

int CtpTd::registerUserSystemInfo(boost::python::object &userSystemInfoField) {
	UserSystemInfoField *p1 = extract<UserSystemInfoField *>(userSystemInfoField);
	return this->api->RegisterUserSystemInfo(p1);
}

int CtpTd::submitUserSystemInfo(boost::python::object &userSystemInfoField) {
	UserSystemInfoField *p1 = extract<UserSystemInfoField *>(userSystemInfoField);
	return this->api->SubmitUserSystemInfo(p1);
}

int CtpTd::reqUserLogin(boost::python::object &reqUserLoginField, int requestId) {
	ReqUserLoginField *p1 = extract<ReqUserLoginField *>(reqUserLoginField);
	return this->api->ReqUserLogin(p1, requestId);
}

int CtpTd::reqUserLogout(boost::python::object &userLogoutField, int requestId) {
	UserLogoutField *p1 = extract<UserLogoutField *>(userLogoutField);
	return this->api->ReqUserLogout(p1, requestId);
}

int CtpTd::reqUserPasswordUpdate(boost::python::object &userPasswordUpdateField, int requestId) {
...
int CtpTd::reqTradingAccountPasswordUpdate(boost::python::object &tradingAccountPasswordUpdateField, int requestId) {
...
int CtpTd::reqUserAuthMethod(boost::python::object &reqUserAuthMethodField, int requestId) {
	ReqUserAuthMethodField *p1 = extract<ReqUserAuthMethodField *>(reqUserAuthMethodField);
	return this->api->ReqUserAuthMethod(p1, requestId);
}

int CtpTd::reqGenUserCaptcha(boost::python::object &reqGenUserCaptchaField, int requestId) {
	ReqGenUserCaptchaField *p1 = extract<ReqGenUserCaptchaField *>(reqGenUserCaptchaField);
	return this->api->ReqGenUserCaptcha(p1, requestId);
}

int CtpTd::reqGenUserText(boost::python::object &reqGenUserTextField, int requestId) {
	ReqGenUserTextField *p1 = extract<ReqGenUserTextField *>(reqGenUserTextField);
	return this->api->ReqGenUserText(p1, requestId);
}

int CtpTd::reqUserLoginWithCaptcha(boost::python::object &reqUserLoginWithCaptchaField, int requestId) {
	ReqUserLoginWithCaptchaField *p1 = extract<ReqUserLoginWithCaptchaField *>(reqUserLoginWithCaptchaField);
	return this->api->ReqUserLoginWithCaptcha(p1, requestId);
}

int CtpTd::reqUserLoginWithText(boost::python::object &reqUserLoginWithTextField, int requestId) {
	ReqUserLoginWithTextField *p1 = extract<ReqUserLoginWithTextField *>(reqUserLoginWithTextField);
	return this->api->ReqUserLoginWithText(p1, requestId);
}

int CtpTd::reqUserLoginWithOTP(boost::python::object &reqUserLoginWithOTPField, int requestId) {
	ReqUserLoginWithOTPField *p1 = extract<ReqUserLoginWithOTPField *>(reqUserLoginWithOTPField);
	return this->api->ReqUserLoginWithOTP(p1, requestId);
}

int CtpTd::reqOrderInsert(boost::python::object &inputOrderField, int requestId) {
	InputOrderField *p1 = extract<InputOrderField *>(inputOrderField);
	return this->api->ReqOrderInsert(p1, requestId);
}

int CtpTd::reqParkedOrderInsert(boost::python::object &parkedOrderField, int requestId) {
	ParkedOrderField *p1 = extract<ParkedOrderField *>(parkedOrderField);
	return this->api->ReqParkedOrderInsert(p1, requestId);
}

int CtpTd::reqParkedOrderAction(boost::python::object &parkedOrderActionField, int requestId) {
...
int CtpTd::reqOrderAction(boost::python::object &inputOrderActionField, int requestId) {
	InputOrderActionField *p1 = extract<InputOrderActionField *>(inputOrderActionField);
	return this->api->ReqOrderAction(p1, requestId);
}

int CtpTd::reqQueryMaxOrderVolume(boost::python::object &queryMaxOrderVolumeField, int requestId) {
...
int CtpTd::reqSettlementInfoConfirm(boost::python::object &settlementInfoConfirmField, int requestId) {
...
int CtpTd::reqRemoveParkedOrder(boost::python::object &removeParkedOrderField, int requestId) {
...
int CtpTd::reqRemoveParkedOrderAction(boost::python::object &removeParkedOrderActionField, int requestId) {
...
int CtpTd::reqExecOrderInsert(boost::python::object &inputExecOrderField, int requestId) {
	InputExecOrderField *p1 = extract<InputExecOrderField *>(inputExecOrderField);
	return this->api->ReqExecOrderInsert(p1, requestId);
}

int CtpTd::reqExecOrderAction(boost::python::object &inputExecOrderActionField, int requestId) {
...
int CtpTd::reqOptionSelfCloseInsert(boost::python::object &inputOptionSelfCloseField, int requestId) {
	InputOptionSelfCloseField *p1 = extract<InputOptionSelfCloseField *>(inputOptionSelfCloseField);
	return this->api->ReqOptionSelfCloseInsert(p1, requestId);
}

int CtpTd::reqOptionSelfCloseAction(boost::python::object &inputOptionSelfCloseActionField, int requestId) {
	InputOptionSelfCloseActionField *p1 = extract<InputOptionSelfCloseActionField *>(inputOptionSelfCloseActionField);
	return this->api->ReqOptionSelfCloseAction(p1, requestId);
}

int CtpTd::reqCombActionInsert(boost::python::object &inputCombActionField, int requestId) {
...
int CtpTd::reqQryOrder(boost::python::object &qryOrderField, int requestId) {
	QryOrderField *p1 = extract<QryOrderField *>(qryOrderField);
	return this->api->ReqQryOrder(p1, requestId);
}

int CtpTd::reqQryTrade(boost::python::object &qryTradeField, int requestId) {
	QryTradeField *p1 = extract<QryTradeField *>(qryTradeField);
	return this->api->ReqQryTrade(p1, requestId);
}

int CtpTd::reqQryInvestorPosition(boost::python::object &qryInvestorPositionField, int requestId) {
...
int CtpTd::reqQryTradingAccount(boost::python::object &qryTradingAccountField, int requestId) {
...
int CtpTd::reqQryInvestor(boost::python::object &qryInvestorField, int requestId) {
	QryInvestorField *p1 = extract<QryInvestorField *>(qryInvestorField);
	return this->api->ReqQryInvestor(p1, requestId);
}

int CtpTd::reqQryTradingCode(boost::python::object &qryTradingCodeField, int requestId) {
	QryTradingCodeField *p1 = extract<QryTradingCodeField *>(qryTradingCodeField);
	return this->api->ReqQryTradingCode(p1, requestId);
}

int CtpTd::reqQryInstrumentMarginRate(boost::python::object &qryInstrumentMarginRateField, int requestId) {
...
int CtpTd::reqQryInstrumentCommissionRate(boost::python::object &qryInstrumentCommissionRateField, int requestId) {
...
int CtpTd::reqQryExchange(boost::python::object &qryExchangeField, int requestId) {
	QryExchangeField *p1 = extract<QryExchangeField *>(qryExchangeField);
	return this->api->ReqQryExchange(p1, requestId);
}

int CtpTd::reqQryProduct(boost::python::object &qryProductField, int requestId) {
	QryProductField *p1 = extract<QryProductField *>(qryProductField);
	return this->api->ReqQryProduct(p1, requestId);
}

int CtpTd::reqQryInstrument(boost::python::object &qryInstrumentField, int requestId) {
	QryInstrumentField *p1 = extract<QryInstrumentField *>(qryInstrumentField);
	return this->api->ReqQryInstrument(p1, requestId);
}

int CtpTd::reqQryDepthMarketData(boost::python::object &qryDepthMarketDataField, int requestId) {
...
int CtpTd::reqQrySettlementInfo(boost::python::object &qrySettlementInfoField, int requestId) {
...
int CtpTd::reqQryTransferBank(boost::python::object &qryTransferBankField, int requestId) {
	QryTransferBankField *p1 = extract<QryTransferBankField *>(qryTransferBankField);
	return this->api->ReqQryTransferBank(p1, requestId);
}

int CtpTd::reqQryInvestorPositionDetail(boost::python::object &qryInvestorPositionDetailField, int requestId) {
...
int CtpTd::reqQryNotice(boost::python::object &qryNoticeField, int requestId) {
	QryNoticeField *p1 = extract<QryNoticeField *>(qryNoticeField);
	return this->api->ReqQryNotice(p1, requestId);
}

int CtpTd::reqQrySettlementInfoConfirm(boost::python::object &qrySettlementInfoConfirmField, int requestId) {
...
int CtpTd::reqQryInvestorPositionCombineDetail(boost::python::object &qryInvestorPositionCombineDetailField, int requestId) {
...
int CtpTd::reqQryCFMMCTradingAccountKey(boost::python::object &qryCFMMCTradingAccountKeyField, int requestId) {
...
int CtpTd::reqQryEWarrantOffset(boost::python::object &qryEWarrantOffsetField, int requestId) {
...
int CtpTd::reqQryInvestorProductGroupMargin(boost::python::object &qryInvestorProductGroupMarginField, int requestId) {
...
int CtpTd::reqQryExchangeMarginRate(boost::python::object &qryExchangeMarginRateField, int requestId) {
...
int CtpTd::reqQryExchangeMarginRateAdjust(boost::python::object &qryExchangeMarginRateAdjustField, int requestId) {
...
int CtpTd::reqQryExchangeRate(boost::python::object &qryExchangeRateField, int requestId) {
	QryExchangeRateField *p1 = extract<QryExchangeRateField *>(qryExchangeRateField);
	return this->api->ReqQryExchangeRate(p1, requestId);
}

int CtpTd::reqQrySecAgentACIDMap(boost::python::object &qrySecAgentACIDMapField, int requestId) {
...
int CtpTd::reqQryProductExchRate(boost::python::object &qryProductExchRateField, int requestId) {
...
int CtpTd::reqQryProductGroup(boost::python::object &qryProductGroupField, int requestId) {
	QryProductGroupField *p1 = extract<QryProductGroupField *>(qryProductGroupField);
	return this->api->ReqQryProductGroup(p1, requestId);
}

int CtpTd::reqQryMMInstrumentCommissionRate(boost::python::object &qryMMInstrumentCommissionRateField, int requestId) {
...
int CtpTd::reqQryMMOptionInstrCommRate(boost::python::object &qryMMOptionInstrCommRateField, int requestId) {
...
int CtpTd::reqQryInstrumentOrderCommRate(boost::python::object &qryInstrumentOrderCommRateField, int requestId) {
...
int CtpTd::reqQrySecAgentTradingAccount(boost::python::object &qryTradingAccountField, int requestId) {
	QryTradingAccountField *p1 = extract<QryTradingAccountField *>(qryTradingAccountField);
	return this->api->ReqQrySecAgentTradingAccount(p1, requestId);
}

int CtpTd::reqQrySecAgentCheckMode(boost::python::object &qrySecAgentCheckModeField, int requestId) {
	QrySecAgentCheckModeField *p1 = extract<QrySecAgentCheckModeField *>(qrySecAgentCheckModeField);
	return this->api->ReqQrySecAgentCheckMode(p1, requestId);
}

int CtpTd::reqQrySecAgentTradeInfo(boost::python::object &qrySecAgentTradeInfoField, int requestId) {
	QrySecAgentTradeInfoField *p1 = extract<QrySecAgentTradeInfoField *>(qrySecAgentTradeInfoField);
	return this->api->ReqQrySecAgentTradeInfo(p1, requestId);
}

int CtpTd::reqQryOptionInstrTradeCost(boost::python::object &qryOptionInstrTradeCostField, int requestId) {
...
int CtpTd::reqQryOptionInstrCommRate(boost::python::object &qryOptionInstrCommRateField, int requestId) {
...
int CtpTd::reqQryExecOrder(boost::python::object &qryExecOrderField, int requestId) {
	QryExecOrderField *p1 = extract<QryExecOrderField *>(qryExecOrderField);
	return this->api->ReqQryExecOrder(p1, requestId);
}

int CtpTd::reqQryForQuote(boost::python::object &qryForQuoteField, int requestId) {
	QryForQuoteField *p1 = extract<QryForQuoteField *>(qryForQuoteField);
	return this->api->ReqQryForQuote(p1, requestId);
}

int CtpTd::reqQryQuote(boost::python::object &qryQuoteField, int requestId) {
	QryQuoteField *p1 = extract<QryQuoteField *>(qryQuoteField);
	return this->api->ReqQryQuote(p1, requestId);
}

int CtpTd::reqQryOptionSelfClose(boost::python::object &qryOptionSelfCloseField, int requestId) {
	QryOptionSelfCloseField *p1 = extract<QryOptionSelfCloseField *>(qryOptionSelfCloseField);
	return this->api->ReqQryOptionSelfClose(p1, requestId);
}

int CtpTd::reqQryInvestUnit(boost::python::object &qryInvestUnitField, int requestId) {
	QryInvestUnitField *p1 = extract<QryInvestUnitField *>(qryInvestUnitField);
	return this->api->ReqQryInvestUnit(p1, requestId);
}

int CtpTd::reqQryCombInstrumentGuard(boost::python::object &qryCombInstrumentGuardField, int requestId) {
...
int CtpTd::reqQryCombAction(boost::python::object &qryCombActionField, int requestId) {
	QryCombActionField *p1 = extract<QryCombActionField *>(qryCombActionField);
	return this->api->ReqQryCombAction(p1, requestId);
}

int CtpTd::reqQryTransferSerial(boost::python::object &qryTransferSerialField, int requestId) {
...
int CtpTd::reqQryAccountregister(boost::python::object &qryAccountregisterField, int requestId) {
...
int CtpTd::reqQryContractBank(boost::python::object &qryContractBankField, int requestId) {
	QryContractBankField *p1 = extract<QryContractBankField *>(qryContractBankField);
	return this->api->ReqQryContractBank(p1, requestId);
}

int CtpTd::reqQryParkedOrder(boost::python::object &qryParkedOrderField, int requestId) {
	QryParkedOrderField *p1 = extract<QryParkedOrderField *>(qryParkedOrderField);
	return this->api->ReqQryParkedOrder(p1, requestId);
}

int CtpTd::reqQryParkedOrderAction(boost::python::object &qryParkedOrderActionField, int requestId) {
...
int CtpTd::reqQryTradingNotice(boost::python::object &qryTradingNoticeField, int requestId) {
...
int CtpTd::reqQryBrokerTradingParams(boost::python::object &qryBrokerTradingParamsField, int requestId) {
...
int CtpTd::reqQryBrokerTradingAlgos(boost::python::object &qryBrokerTradingAlgosField, int requestId) {
...
int CtpTd::reqQueryCFMMCTradingAccountToken(boost::python::object &queryCFMMCTradingAccountTokenField, int requestId) {
...
int CtpTd::reqFromBankToFutureByFuture(boost::python::object &reqTransferField, int requestId) {
	ReqTransferField *p1 = extract<ReqTransferField *>(reqTransferField);
	return this->api->ReqFromBankToFutureByFuture(p1, requestId);
}

int CtpTd::reqFromFutureToBankByFuture(boost::python::object &reqTransferField, int requestId) {
	ReqTransferField *p1 = extract<ReqTransferField *>(reqTransferField);
	return this->api->ReqFromFutureToBankByFuture(p1, requestId);
}

int CtpTd::reqQueryBankAccountMoneyByFuture(boost::python::object &reqQueryAccountField, int requestId) {
...
struct CtpTdWrap : CtpTd, wrapper<CtpTd> {
    ...
    virtual void onRspUserAuthMethod(object &rspUserAuthMethodField, object &rspInfoField, int requestId, bool final) {
        try {
            this->get_override("onRspUserAuthMethod")(rspUserAuthMethodField, rspInfoField, requestId, final);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };

    virtual void onRspGenUserCaptcha(object &rspGenUserCaptchaField, object &rspInfoField, int requestId, bool final) {
        try {
            this->get_override("onRspGenUserCaptcha")(rspGenUserCaptchaField, rspInfoField, requestId, final);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };

    virtual void onRspGenUserText(object &rspGenUserTextField, object &rspInfoField, int requestId, bool final) {
        try {
            this->get_override("onRspGenUserText")(rspGenUserTextField, rspInfoField, requestId, final);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };
    ...
    virtual void onRspOptionSelfCloseInsert(object &inputOptionSelfCloseField, object &rspInfoField, int requestId, bool final) {
        try {
            this->get_override("onRspOptionSelfCloseInsert")(inputOptionSelfCloseField, rspInfoField, requestId, final);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };

    virtual void onRspOptionSelfCloseAction(object &inputOptionSelfCloseActionField, object &rspInfoField, int requestId, bool final) {
        try {
            this->get_override("onRspOptionSelfCloseAction")(inputOptionSelfCloseActionField, rspInfoField, requestId, final);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };
    ...
    virtual void onRspQrySecAgentTradingAccount(object &tradingAccountField, object &rspInfoField, int requestId, bool final) {
        try {
            this->get_override("onRspQrySecAgentTradingAccount")(tradingAccountField, rspInfoField, requestId, final);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };

    virtual void onRspQrySecAgentCheckMode(object &secAgentCheckModeField, object &rspInfoField, int requestId, bool final) {
        try {
            this->get_override("onRspQrySecAgentCheckMode")(secAgentCheckModeField, rspInfoField, requestId, final);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };

    virtual void onRspQrySecAgentTradeInfo(object &secAgentTradeInfoField, object &rspInfoField, int requestId, bool final) {
        try {
            this->get_override("onRspQrySecAgentTradeInfo")(secAgentTradeInfoField, rspInfoField, requestId, final);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };
    ...
    virtual void onRspQryOptionSelfClose(object &optionSelfCloseField,object &rspInfoField, int requestId, bool final) {
        try {
            this->get_override("onRspQryOptionSelfClose")(optionSelfCloseField, rspInfoField, requestId, final);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };

    virtual void onRspQryInvestUnit(object &investUnitField, object &rspInfoField, int requestId, bool final) {
        try {
            this->get_override("onRspQryInvestUnit")(investUnitField, rspInfoField, requestId, final);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };
    ...
    virtual void onRtnOptionSelfClose(object &optionSelfCloseField) {
        try {
            this->get_override("onRtnOptionSelfClose")(optionSelfCloseField);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };

    virtual void onErrRtnOptionSelfCloseInsert(object &inputOptionSelfCloseField, object &rspInfoField) {
        try {
            this->get_override("onErrRtnOptionSelfCloseInsert")(inputOptionSelfCloseField, rspInfoField);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };

    virtual void onErrRtnOptionSelfCloseAction(object &optionSelfCloseActionField, object &rspInfoField) {
        try {
            this->get_override("onErrRtnOptionSelfCloseAction")(optionSelfCloseActionField, rspInfoField);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };
...
BOOST_PYTHON_MODULE(ctptd) {
    ...
    class_<CtpTdWrap, boost::noncopyable>("CtpTd",init<const std::string &>())
        ...
        .def("onRspUserAuthMethod", pure_virtual(&CtpTdWrap::onRspUserAuthMethod))
        .def("onRspGenUserCaptcha", pure_virtual(&CtpTdWrap::onRspGenUserCaptcha))
        .def("onRspGenUserText", pure_virtual(&CtpTdWrap::onRspGenUserText))
        ...
        .def("onRspOptionSelfCloseInsert", pure_virtual(&CtpTdWrap::onRspOptionSelfCloseInsert))
        .def("onRspOptionSelfCloseAction", pure_virtual(&CtpTdWrap::onRspOptionSelfCloseAction))
        ...
        .def("onRspQrySecAgentTradingAccount", pure_virtual(&CtpTdWrap::onRspQrySecAgentTradingAccount))
        .def("onRspQrySecAgentCheckMode", pure_virtual(&CtpTdWrap::onRspQrySecAgentCheckMode))
        .def("onRspQrySecAgentTradeInfo", pure_virtual(&CtpTdWrap::onRspQrySecAgentTradeInfo))
        ...
        .def("onRspQryOptionSelfClose", pure_virtual(&CtpTdWrap::onRspQryOptionSelfClose))
        .def("onRspQryInvestUnit", pure_virtual(&CtpTdWrap::onRspQryInvestUnit))
        ...
        .def("onRtnOptionSelfClose", pure_virtual(&CtpTdWrap::onRtnOptionSelfClose))
        .def("onErrRtnOptionSelfCloseInsert", pure_virtual(&CtpTdWrap::onErrRtnOptionSelfCloseInsert))
        .def("onErrRtnOptionSelfCloseAction", pure_virtual(&CtpTdWrap::onErrRtnOptionSelfCloseAction))
        ...
        .def("registerUserSystemInfo", &CtpTdWrap::registerUserSystemInfo)
        .def("submitUserSystemInfo", &CtpTdWrap::submitUserSystemInfo)
        ...
        .def("reqUserAuthMethod", &CtpTdWrap::reqUserAuthMethod)
        .def("reqGenUserCaptcha", &CtpTdWrap::reqGenUserCaptcha)
        .def("reqGenUserText", &CtpTdWrap::reqGenUserText)
        .def("reqUserLoginWithCaptcha", &CtpTdWrap::reqUserLoginWithCaptcha)
        .def("reqUserLoginWithText", &CtpTdWrap::reqUserLoginWithText)
        .def("reqUserLoginWithOTP", &CtpTdWrap::reqUserLoginWithOTP)
        ...
        .def("reqOptionSelfCloseInsert", &CtpTdWrap::reqOptionSelfCloseInsert)
        .def("reqOptionSelfCloseAction", &CtpTdWrap::reqOptionSelfCloseAction)
        ...
        .def("reqQrySecAgentTradingAccount", &CtpTdWrap::reqQrySecAgentTradingAccount)
        .def("reqQrySecAgentCheckMode", &CtpTdWrap::reqQrySecAgentCheckMode)
        .def("reqQrySecAgentTradeInfo", &CtpTdWrap::reqQrySecAgentTradeInfo)
        ...
        .def("reqQryOptionSelfClose", &CtpTdWrap::reqQryOptionSelfClose)
        .def("reqQryInvestUnit", &CtpTdWrap::reqQryInvestUnit)
    ...
    enum_<THOST_TE_RESUME_TYPE>("tert")
		...
		.def_readwrite("clientIPPort", &ReqUserLoginField::ClientIPPort);
	...
	class_<ReqAuthenticateField>("ReqAuthenticateField")
		...
		.add_property("appID", &ReqAuthenticateField::getAppID, &ReqAuthenticateField::setAppID);
	...
	class_<RspAuthenticateField>("RspAuthenticateField")
		...
		.add_property("appID", &RspAuthenticateField::getAppID, &RspAuthenticateField::setAppID)
		.def_readwrite("appType", &RspAuthenticateField::AppType);
	...
	class_<TradingCodeField>("TradingCodeField")
		...
		.add_property("branchID", &TradingCodeField::getBranchID, &TradingCodeField::setBranchID)
		.def_readwrite("bizType", &TradingCodeField::BizType)
		.add_property("investUnitID", &TradingCodeField::getInvestUnitID, &TradingCodeField::setInvestUnitID);
	...
	class_<TradingAccountField>("TradingAccountField")
		...
		.def_readwrite("bizType", &TradingAccountField::BizType)
		.def_readwrite("frozenSwap", &TradingAccountField::FrozenSwap)
		.def_readwrite("remainSwap", &TradingAccountField::RemainSwap);
	...
	class_<InvestorPositionField>("InvestorPositionField")
		...
		.add_property("exchangeID", &InvestorPositionField::getExchangeID, &InvestorPositionField::setExchangeID)
		.def_readwrite("ydStrikeFrozen", &InvestorPositionField::YdStrikeFrozen)
		.add_property("investUnitID", &InvestorPositionField::getInvestUnitID, &InvestorPositionField::setInvestUnitID)
		.def_readwrite("positionCostOffset", &InvestorPositionField::PositionCostOffset);
	...
	class_<InstrumentMarginRateField>("InstrumentMarginRateField")
		...
		.add_property("exchangeID", &InstrumentMarginRateField::getExchangeID, &InstrumentMarginRateField::setExchangeID)
		.add_property("investUnitID", &InstrumentMarginRateField::getInvestUnitID, &InstrumentMarginRateField::setInvestUnitID);
	...
	class_<InstrumentCommissionRateField>("InstrumentCommissionRateField")
		...
		.add_property("exchangeID", &InstrumentCommissionRateField::getExchangeID, &InstrumentCommissionRateField::setExchangeID)
		.def_readwrite("bizType", &InstrumentCommissionRateField::BizType)
		.add_property("investUnitID", &InstrumentCommissionRateField::getInvestUnitID, &InstrumentCommissionRateField::setInvestUnitID);
	...
	class_<SettlementInfoField>("SettlementInfoField")
		...
		.add_property("accountID", &SettlementInfoField::getAccountID, &SettlementInfoField::setAccountID)
		.add_property("currencyID", &SettlementInfoField::getCurrencyID, &SettlementInfoField::setCurrencyID);
	...
	class_<ExchangeMarginRateField>("ExchangeMarginRateField")
		...
		.add_property("exchangeID", &ExchangeMarginRateField::getExchangeID, &ExchangeMarginRateField::setExchangeID);
	...
	class_<TradeField>("TradeField")
		...
		.add_property("investUnitID", &TradeField::getInvestUnitID, &TradeField::setInvestUnitID);
	...
	class_<QueryMaxOrderVolumeField>("QueryMaxOrderVolumeField")
		...
		.add_property("exchangeID", &QueryMaxOrderVolumeField::getExchangeID, &QueryMaxOrderVolumeField::setExchangeID)
		.add_property("investUnitID", &QueryMaxOrderVolumeField::getInvestUnitID, &QueryMaxOrderVolumeField::setInvestUnitID);
	...
	class_<SettlementInfoConfirmField>("SettlementInfoConfirmField")
		...
		.def_readwrite("settlementID", &SettlementInfoConfirmField::SettlementID)
		.add_property("accountID", &SettlementInfoConfirmField::getAccountID, &SettlementInfoConfirmField::setAccountID)
		.add_property("currencyID", &SettlementInfoConfirmField::getCurrencyID, &SettlementInfoConfirmField::setCurrencyID);
	...
	class_<QryOrderField>("QryOrderField")
		...
		.add_property("investUnitID", &QryOrderField::getInvestUnitID, &QryOrderField::setInvestUnitID);
	...
	class_<QryTradeField>("QryTradeField")
		...
		.add_property("investUnitID", &QryTradeField::getInvestUnitID, &QryTradeField::setInvestUnitID);
	...
	class_<QryInvestorPositionField>("QryInvestorPositionField")
		...
		.add_property("exchangeID", &QryInvestorPositionField::getExchangeID, &QryInvestorPositionField::setExchangeID)
		.add_property("investUnitID", &QryInvestorPositionField::getInvestUnitID, &QryInvestorPositionField::setInvestUnitID);
	...
	class_<QryTradingAccountField>("QryTradingAccountField")
		...
		.def_readwrite("bizType", &QryTradingAccountField::BizType)
		.add_property("accountID", &QryTradingAccountField::getAccountID, &QryTradingAccountField::setAccountID);
	...
	class_<QryTradingCodeField>("QryTradingCodeField")
		...
		.add_property("investUnitID", &QryTradingCodeField::getInvestUnitID, &QryTradingCodeField::setInvestUnitID);
	...
	class_<QryInstrumentMarginRateField>("QryInstrumentMarginRateField")
		...
		.add_property("exchangeID", &QryInstrumentMarginRateField::getExchangeID, &QryInstrumentMarginRateField::setExchangeID)
		.add_property("investUnitID", &QryInstrumentMarginRateField::getInvestUnitID, &QryInstrumentMarginRateField::setInvestUnitID);
	...
	class_<QryInstrumentCommissionRateField>("QryInstrumentCommissionRateField")
		...
		.add_property("exchangeID", &QryInstrumentCommissionRateField::getExchangeID, &QryInstrumentCommissionRateField::setExchangeID)
		.add_property("investUnitID", &QryInstrumentCommissionRateField::getInvestUnitID, &QryInstrumentCommissionRateField::setInvestUnitID);
	...
	class_<QryProductField>("QryProductField")
		...
		.add_property("exchangeID", &QryProductField::getExchangeID, &QryProductField::setExchangeID);
	...
	class_<QryDepthMarketDataField>("QryDepthMarketDataField")
		...
		.add_property("exchangeID", &QryDepthMarketDataField::getExchangeID, &QryDepthMarketDataField::setExchangeID);
	...
	class_<QrySettlementInfoField>("QrySettlementInfoField")
		...
		.add_property("accountID", &QrySettlementInfoField::getAccountID, &QrySettlementInfoField::setAccountID)
		.add_property("currencyID", &QrySettlementInfoField::getCurrencyID, &QrySettlementInfoField::setCurrencyID);
	...
	class_<QryExchangeMarginRateField>("QryExchangeMarginRateField")
		...
		.add_property("exchangeID", &QryExchangeMarginRateField::getExchangeID, &QryExchangeMarginRateField::setExchangeID);
	...
	class_<OptionInstrCommRateField>("OptionInstrCommRateField")
		...
		.add_property("exchangeID", &OptionInstrCommRateField::getExchangeID, &OptionInstrCommRateField::setExchangeID)
		.add_property("investUnitID", &OptionInstrCommRateField::getInvestUnitID, &OptionInstrCommRateField::setInvestUnitID);
	...
	class_<OptionInstrTradeCostField>("OptionInstrTradeCostField")
		...
		.add_property("exchangeID", &OptionInstrTradeCostField::getExchangeID, &OptionInstrTradeCostField::setExchangeID)
		.add_property("investUnitID", &OptionInstrTradeCostField::getInvestUnitID, &OptionInstrTradeCostField::setInvestUnitID);
	...
	class_<QryOptionInstrTradeCostField>("QryOptionInstrTradeCostField")
		...
		.add_property("exchangeID", &QryOptionInstrTradeCostField::getExchangeID, &QryOptionInstrTradeCostField::setExchangeID)
		.add_property("investUnitID", &QryOptionInstrTradeCostField::getInvestUnitID, &QryOptionInstrTradeCostField::setInvestUnitID);
	...
	class_<QryOptionInstrCommRateField>("QryOptionInstrCommRateField")
		...
		.add_property("exchangeID", &QryOptionInstrCommRateField::getExchangeID, &QryOptionInstrCommRateField::setExchangeID)
		.add_property("investUnitID", &QryOptionInstrCommRateField::getInvestUnitID, &QryOptionInstrCommRateField::setInvestUnitID);
	...
	class_<QryForQuoteField>("QryForQuoteField")
		...
		.add_property("investUnitID", &QryForQuoteField::getInvestUnitID, &QryForQuoteField::setInvestUnitID);
	...
	class_<QryQuoteField>("QryQuoteField")
		...
		.add_property("investUnitID", &QryQuoteField::getInvestUnitID, &QryQuoteField::setInvestUnitID);
	...
	class_<CombInstrumentGuardField>("CombInstrumentGuardField")
		...
		.add_property("exchangeID", &CombInstrumentGuardField::getExchangeID, &CombInstrumentGuardField::setExchangeID);
	...
	class_<QryCombInstrumentGuardField>("QryCombInstrumentGuardField")
		...
		.add_property("exchangeID", &QryCombInstrumentGuardField::getExchangeID, &QryCombInstrumentGuardField::setExchangeID);
	...
	class_<InputCombActionField>("InputCombActionField")
		...
		.add_property("investUnitID", &InputCombActionField::getInvestUnitID, &InputCombActionField::setInvestUnitID);
	...
	class_<CombActionField>("CombActionField")
		...
		.add_property("comTradeID", &CombActionField::getComTradeID, &CombActionField::setComTradeID)
		.add_property("branchID", &CombActionField::getBranchID, &CombActionField::setBranchID)
		.add_property("investUnitID", &CombActionField::getInvestUnitID, &CombActionField::setInvestUnitID);
	...
	class_<QryCombActionField>("QryCombActionField")
		...
		.add_property("investUnitID", &QryCombActionField::getInvestUnitID, &QryCombActionField::setInvestUnitID);
	...
	class_<ProductExchRateField>("ProductExchRateField")
		...
		.add_property("exchangeID", &ProductExchRateField::getExchangeID, &ProductExchRateField::setExchangeID);
	...
	class_<QryProductExchRateField>("QryProductExchRateField")
		...
		.add_property("exchangeID", &QryProductExchRateField::getExchangeID, &QryProductExchRateField::setExchangeID);
	...
	class_<InstrumentOrderCommRateField>("InstrumentOrderCommRateField")
		...
		.add_property("exchangeID", &InstrumentOrderCommRateField::getExchangeID, &InstrumentOrderCommRateField::setExchangeID)
		.add_property("investUnitID", &InstrumentOrderCommRateField::getInvestUnitID, &InstrumentOrderCommRateField::setInvestUnitID);
	...
	class_<InputOptionSelfCloseField>("InputOptionSelfCloseField")
		.add_property("brokerID", &InputOptionSelfCloseField::getBrokerID, &InputOptionSelfCloseField::setBrokerID)
		.add_property("investorID", &InputOptionSelfCloseField::getInvestorID, &InputOptionSelfCloseField::setInvestorID)
		.add_property("instrumentID", &InputOptionSelfCloseField::getInstrumentID, &InputOptionSelfCloseField::setInstrumentID)
		.add_property("optionSelfCloseRef", &InputOptionSelfCloseField::getOptionSelfCloseRef, &InputOptionSelfCloseField::setOptionSelfCloseRef)
		.add_property("userID", &InputOptionSelfCloseField::getUserID, &InputOptionSelfCloseField::setUserID)
		.def_readwrite("volume", &InputOptionSelfCloseField::Volume)
		.def_readwrite("requestID", &InputOptionSelfCloseField::RequestID)
		.add_property("businessUnit", &InputOptionSelfCloseField::getBusinessUnit, &InputOptionSelfCloseField::setBusinessUnit)
		.def_readwrite("hedgeFlag", &InputOptionSelfCloseField::HedgeFlag)
		.def_readwrite("optSelfCloseFlag", &InputOptionSelfCloseField::OptSelfCloseFlag)
		.add_property("exchangeID", &InputOptionSelfCloseField::getExchangeID, &InputOptionSelfCloseField::setExchangeID)
		.add_property("investUnitID", &InputOptionSelfCloseField::getInvestUnitID, &InputOptionSelfCloseField::setInvestUnitID)
		.add_property("accountID", &InputOptionSelfCloseField::getAccountID, &InputOptionSelfCloseField::setAccountID)
		.add_property("currencyID", &InputOptionSelfCloseField::getCurrencyID, &InputOptionSelfCloseField::setCurrencyID)
		.add_property("clientID", &InputOptionSelfCloseField::getClientID, &InputOptionSelfCloseField::setClientID)
		.add_property("IPAddress", &InputOptionSelfCloseField::getIPAddress, &InputOptionSelfCloseField::setIPAddress)
		.add_property("macAddress", &InputOptionSelfCloseField::getMacAddress, &InputOptionSelfCloseField::setMacAddress);

	class_<InputOptionSelfCloseActionField>("InputOptionSelfCloseActionField")
		.add_property("brokerID", &InputOptionSelfCloseActionField::getBrokerID, &InputOptionSelfCloseActionField::setBrokerID)
		.add_property("investorID", &InputOptionSelfCloseActionField::getInvestorID, &InputOptionSelfCloseActionField::setInvestorID)
		.def_readwrite("optionSelfCloseActionRef", &InputOptionSelfCloseActionField::OptionSelfCloseActionRef)
		.add_property("optionSelfCloseRef", &InputOptionSelfCloseActionField::getOptionSelfCloseRef, &InputOptionSelfCloseActionField::setOptionSelfCloseRef)
		.def_readwrite("requestID", &InputOptionSelfCloseActionField::RequestID)
		.def_readwrite("frontID", &InputOptionSelfCloseActionField::FrontID)
		.def_readwrite("sessionID", &InputOptionSelfCloseActionField::SessionID)
		.add_property("exchangeID", &InputOptionSelfCloseActionField::getExchangeID, &InputOptionSelfCloseActionField::setExchangeID)
		.add_property("optionSelfCloseSysID", &InputOptionSelfCloseActionField::getOptionSelfCloseSysID, &InputOptionSelfCloseActionField::setOptionSelfCloseSysID)
		.def_readwrite("actionFlag", &InputOptionSelfCloseActionField::ActionFlag)
		.add_property("userID", &InputOptionSelfCloseActionField::getUserID, &InputOptionSelfCloseActionField::setUserID)
		.add_property("instrumentID", &InputOptionSelfCloseActionField::getInstrumentID, &InputOptionSelfCloseActionField::setInstrumentID)
		.add_property("investUnitID", &InputOptionSelfCloseActionField::getInvestUnitID, &InputOptionSelfCloseActionField::setInvestUnitID)
		.add_property("IPAddress", &InputOptionSelfCloseActionField::getIPAddress, &InputOptionSelfCloseActionField::setIPAddress)
		.add_property("macAddress", &InputOptionSelfCloseActionField::getMacAddress, &InputOptionSelfCloseActionField::setMacAddress);

	class_<OptionSelfCloseField>("OptionSelfCloseField")
		.add_property("brokerID", &OptionSelfCloseField::getBrokerID, &OptionSelfCloseField::setBrokerID)
		.add_property("investorID", &OptionSelfCloseField::getInvestorID, &OptionSelfCloseField::setInvestorID)
		.add_property("instrumentID", &OptionSelfCloseField::getInstrumentID, &OptionSelfCloseField::setInstrumentID)
		.add_property("optionSelfCloseRef", &OptionSelfCloseField::getOptionSelfCloseRef, &OptionSelfCloseField::setOptionSelfCloseRef)
		.add_property("userID", &OptionSelfCloseField::getUserID, &OptionSelfCloseField::setUserID)
		.def_readwrite("volume", &OptionSelfCloseField::Volume)
		.def_readwrite("requestID", &OptionSelfCloseField::RequestID)
		.add_property("businessUnit", &OptionSelfCloseField::getBusinessUnit, &OptionSelfCloseField::setBusinessUnit)
		.def_readwrite("hedgeFlag", &OptionSelfCloseField::HedgeFlag)
		.def_readwrite("optSelfCloseFlag", &OptionSelfCloseField::OptSelfCloseFlag)
		.add_property("optionSelfCloseLocalID", &OptionSelfCloseField::getOptionSelfCloseLocalID, &OptionSelfCloseField::setOptionSelfCloseLocalID)
		.add_property("exchangeID", &OptionSelfCloseField::getExchangeID, &OptionSelfCloseField::setExchangeID)
		.add_property("participantID", &OptionSelfCloseField::getParticipantID, &OptionSelfCloseField::setParticipantID)
		.add_property("clientID", &OptionSelfCloseField::getClientID, &OptionSelfCloseField::setClientID)
		.add_property("exchangeInstID", &OptionSelfCloseField::getExchangeInstID, &OptionSelfCloseField::setExchangeInstID)
		.add_property("traderID", &OptionSelfCloseField::getTraderID, &OptionSelfCloseField::setTraderID)
		.def_readwrite("installID", &OptionSelfCloseField::InstallID)
		.def_readwrite("orderSubmitStatus", &OptionSelfCloseField::OrderSubmitStatus)
		.def_readwrite("notifySequence", &OptionSelfCloseField::NotifySequence)
		.add_property("tradingDay", &OptionSelfCloseField::getTradingDay, &OptionSelfCloseField::setTradingDay)
		.def_readwrite("settlementID", &OptionSelfCloseField::SettlementID)
		.add_property("optionSelfCloseSysID", &OptionSelfCloseField::getOptionSelfCloseSysID, &OptionSelfCloseField::setOptionSelfCloseSysID)
		.add_property("insertDate", &OptionSelfCloseField::getInsertDate, &OptionSelfCloseField::setInsertDate)
		.add_property("insertTime", &OptionSelfCloseField::getInsertTime, &OptionSelfCloseField::setInsertTime)
		.add_property("cancelTime", &OptionSelfCloseField::getCancelTime, &OptionSelfCloseField::setCancelTime)
		.def_readwrite("execResult", &OptionSelfCloseField::ExecResult)
		.add_property("clearingPartID", &OptionSelfCloseField::getClearingPartID, &OptionSelfCloseField::setClearingPartID)
		.def_readwrite("sequenceNo", &OptionSelfCloseField::SequenceNo)
		.def_readwrite("frontID", &OptionSelfCloseField::FrontID)
		.def_readwrite("sessionID", &OptionSelfCloseField::SessionID)
		.add_property("userProductInfo", &OptionSelfCloseField::getUserProductInfo, &OptionSelfCloseField::setUserProductInfo)
		.add_property("statusMsg", &OptionSelfCloseField::getStatusMsg, &OptionSelfCloseField::setStatusMsg)
		.add_property("activeUserID", &OptionSelfCloseField::getActiveUserID, &OptionSelfCloseField::setActiveUserID)
		.def_readwrite("brokerOptionSelfCloseSeq", &OptionSelfCloseField::BrokerOptionSelfCloseSeq)
		.add_property("branchID", &OptionSelfCloseField::getBranchID, &OptionSelfCloseField::setBranchID)
		.add_property("investUnitID", &OptionSelfCloseField::getInvestUnitID, &OptionSelfCloseField::setInvestUnitID)
		.add_property("accountID", &OptionSelfCloseField::getAccountID, &OptionSelfCloseField::setAccountID)
		.add_property("currencyID", &OptionSelfCloseField::getCurrencyID, &OptionSelfCloseField::setCurrencyID)
		.add_property("IPAddress", &OptionSelfCloseField::getIPAddress, &OptionSelfCloseField::setIPAddress)
		.add_property("macAddress", &OptionSelfCloseField::getMacAddress, &OptionSelfCloseField::setMacAddress);

	class_<OptionSelfCloseActionField>("OptionSelfCloseActionField")
		.add_property("brokerID", &OptionSelfCloseActionField::getBrokerID, &OptionSelfCloseActionField::setBrokerID)
		.add_property("investorID", &OptionSelfCloseActionField::getInvestorID, &OptionSelfCloseActionField::setInvestorID)
		.def_readwrite("optionSelfCloseActionRef", &OptionSelfCloseActionField::OptionSelfCloseActionRef)
		.add_property("optionSelfCloseRef", &OptionSelfCloseActionField::getOptionSelfCloseRef, &OptionSelfCloseActionField::setOptionSelfCloseRef)
		.def_readwrite("requestID", &OptionSelfCloseActionField::RequestID)
		.def_readwrite("frontID", &OptionSelfCloseActionField::FrontID)
		.def_readwrite("sessionID", &OptionSelfCloseActionField::SessionID)
		.add_property("exchangeID", &OptionSelfCloseActionField::getExchangeID, &OptionSelfCloseActionField::setExchangeID)
		.add_property("optionSelfCloseSysID", &OptionSelfCloseActionField::getOptionSelfCloseSysID, &OptionSelfCloseActionField::setOptionSelfCloseSysID)
		.def_readwrite("actionFlag", &OptionSelfCloseActionField::ActionFlag)
		.add_property("actionDate", &OptionSelfCloseActionField::getActionDate, &OptionSelfCloseActionField::setActionDate)
		.add_property("actionTime", &OptionSelfCloseActionField::getActionTime, &OptionSelfCloseActionField::setActionTime)
		.add_property("traderID", &OptionSelfCloseActionField::getTraderID, &OptionSelfCloseActionField::setTraderID)
		.def_readwrite("installID", &OptionSelfCloseActionField::InstallID)
		.add_property("optionSelfCloseLocalID", &OptionSelfCloseActionField::getOptionSelfCloseLocalID, &OptionSelfCloseActionField::setOptionSelfCloseLocalID)
		.add_property("actionLocalID", &OptionSelfCloseActionField::getActionLocalID, &OptionSelfCloseActionField::setActionLocalID)
		.add_property("participantID", &OptionSelfCloseActionField::getParticipantID, &OptionSelfCloseActionField::setParticipantID)
		.add_property("clientID", &OptionSelfCloseActionField::getClientID, &OptionSelfCloseActionField::setClientID)
		.add_property("businessUnit", &OptionSelfCloseActionField::getBusinessUnit, &OptionSelfCloseActionField::setBusinessUnit)
		.def_readwrite("orderActionStatus", &OptionSelfCloseActionField::OrderActionStatus)
		.add_property("userID", &OptionSelfCloseActionField::getUserID, &OptionSelfCloseActionField::setUserID)
		.add_property("statusMsg", &OptionSelfCloseActionField::getStatusMsg, &OptionSelfCloseActionField::setStatusMsg)
		.add_property("instrumentID", &OptionSelfCloseActionField::getInstrumentID, &OptionSelfCloseActionField::setInstrumentID)
		.add_property("branchID", &OptionSelfCloseActionField::getBranchID, &OptionSelfCloseActionField::setBranchID)
		.add_property("investUnitID", &OptionSelfCloseActionField::getInvestUnitID, &OptionSelfCloseActionField::setInvestUnitID)
		.add_property("IPAddress", &OptionSelfCloseActionField::getIPAddress, &OptionSelfCloseActionField::setIPAddress)
		.add_property("macAddress", &OptionSelfCloseActionField::getMacAddress, &OptionSelfCloseActionField::setMacAddress);

	class_<QryOptionSelfCloseField>("QryOptionSelfCloseField")
		.add_property("brokerID", &QryOptionSelfCloseField::getBrokerID, &QryOptionSelfCloseField::setBrokerID)
		.add_property("investorID", &QryOptionSelfCloseField::getInvestorID, &QryOptionSelfCloseField::setInvestorID)
		.add_property("instrumentID", &QryOptionSelfCloseField::getInstrumentID, &QryOptionSelfCloseField::setInstrumentID)
		.add_property("exchangeID", &QryOptionSelfCloseField::getExchangeID, &QryOptionSelfCloseField::setExchangeID)
		.add_property("optionSelfCloseSysID", &QryOptionSelfCloseField::getOptionSelfCloseSysID, &QryOptionSelfCloseField::setOptionSelfCloseSysID)
		.add_property("insertTimeStart", &QryOptionSelfCloseField::getInsertTimeStart, &QryOptionSelfCloseField::setInsertTimeStart)
		.add_property("insertTimeEnd", &QryOptionSelfCloseField::getInsertTimeEnd, &QryOptionSelfCloseField::setInsertTimeEnd);

	class_<InvestUnitField>("InvestUnitField")
		.add_property("brokerID", &InvestUnitField::getBrokerID, &InvestUnitField::setBrokerID)
		.add_property("investorID", &InvestUnitField::getInvestorID, &InvestUnitField::setInvestorID)
		.add_property("investUnitID", &InvestUnitField::getInvestUnitID, &InvestUnitField::setInvestUnitID)
		.add_property("investorUnitName", &InvestUnitField::getInvestorUnitName, &InvestUnitField::setInvestorUnitName)
		.add_property("investorGroupID", &InvestUnitField::getInvestorGroupID, &InvestUnitField::setInvestorGroupID)
		.add_property("commModelID", &InvestUnitField::getCommModelID, &InvestUnitField::setCommModelID)
		.add_property("marginModelID", &InvestUnitField::getMarginModelID, &InvestUnitField::setMarginModelID)
		.add_property("accountID", &InvestUnitField::getAccountID, &InvestUnitField::setAccountID)
		.add_property("currencyID", &InvestUnitField::getCurrencyID, &InvestUnitField::setCurrencyID);

	class_<QryInvestUnitField>("QryInvestUnitField")
		.add_property("brokerID", &QryInvestUnitField::getBrokerID, &QryInvestUnitField::setBrokerID)
		.add_property("investorID", &QryInvestUnitField::getInvestorID, &QryInvestUnitField::setInvestorID)
		.add_property("investUnitID", &QryInvestUnitField::getInvestUnitID, &QryInvestUnitField::setInvestUnitID);

	class_<SecAgentCheckModeField>("SecAgentCheckModeField")
		.add_property("investorID", &SecAgentCheckModeField::getInvestorID, &SecAgentCheckModeField::setInvestorID)
		.add_property("brokerID", &SecAgentCheckModeField::getBrokerID, &SecAgentCheckModeField::setBrokerID)
		.add_property("currencyID", &SecAgentCheckModeField::getCurrencyID, &SecAgentCheckModeField::setCurrencyID)
		.add_property("brokerSecAgentID", &SecAgentCheckModeField::getBrokerSecAgentID, &SecAgentCheckModeField::setBrokerSecAgentID)
		.def_readwrite("checkSelfAccount", &SecAgentCheckModeField::CheckSelfAccount);

	class_<SecAgentTradeInfoField>("SecAgentTradeInfoField")
		.add_property("brokerID", &SecAgentTradeInfoField::getBrokerID, &SecAgentTradeInfoField::setBrokerID)
		.add_property("brokerSecAgentID", &SecAgentTradeInfoField::getBrokerSecAgentID, &SecAgentTradeInfoField::setBrokerSecAgentID)
		.add_property("investorID", &SecAgentTradeInfoField::getInvestorID, &SecAgentTradeInfoField::setInvestorID)
		.add_property("longCustomerName", &SecAgentTradeInfoField::getLongCustomerName, &SecAgentTradeInfoField::setLongCustomerName);
	...
	class_<QryInvestorPositionDetailField>("QryInvestorPositionDetailField")
		...
		.add_property("exchangeID", &QryInvestorPositionDetailField::getExchangeID, &QryInvestorPositionDetailField::setExchangeID)
		.add_property("investUnitID", &QryInvestorPositionDetailField::getInvestUnitID, &QryInvestorPositionDetailField::setInvestUnitID);
	...
	class_<InvestorPositionDetailField>("InvestorPositionDetailField")
		...
		.def_readwrite("timeFirstVolume", &InvestorPositionDetailField::TimeFirstVolume)
		.add_property("investUnitID", &InvestorPositionDetailField::getInvestUnitID, &InvestorPositionDetailField::setInvestUnitID);
	...
	class_<QrySettlementInfoConfirmField>("QrySettlementInfoConfirmField")
		...
		.add_property("accountID", &QrySettlementInfoConfirmField::getAccountID, &QrySettlementInfoConfirmField::setAccountID)
		.add_property("currencyID", &QrySettlementInfoConfirmField::getCurrencyID, &QrySettlementInfoConfirmField::setCurrencyID);
	...
	class_<InvestorPositionCombineDetailField>("InvestorPositionCombineDetailField")
		...
		.add_property("investUnitID", &InvestorPositionCombineDetailField::getInvestUnitID, &InvestorPositionCombineDetailField::setInvestUnitID);
	...
	class_<QryParkedOrderField>("QryParkedOrderField")
		...
		.add_property("investUnitID", &QryParkedOrderField::getInvestUnitID, &QryParkedOrderField::setInvestUnitID);
	...
	class_<QryParkedOrderActionField>("QryParkedOrderActionField")
		...
		.add_property("investUnitID", &QryParkedOrderActionField::getInvestUnitID, &QryParkedOrderActionField::setInvestUnitID);
	...
	class_<RemoveParkedOrderField>("RemoveParkedOrderField")
		...
		.add_property("investUnitID", &RemoveParkedOrderField::getInvestUnitID, &RemoveParkedOrderField::setInvestUnitID);
	...
	class_<RemoveParkedOrderActionField>("RemoveParkedOrderActionField")
		...
		.add_property("investUnitID", &RemoveParkedOrderActionField::getInvestUnitID, &RemoveParkedOrderActionField::setInvestUnitID);
	...
	class_<QryInvestorPositionCombineDetailField>("QryInvestorPositionCombineDetailField")
		...
		.add_property("exchangeID", &QryInvestorPositionCombineDetailField::getExchangeID, &QryInvestorPositionCombineDetailField::setExchangeID)
		.add_property("investUnitID", &QryInvestorPositionCombineDetailField::getInvestUnitID, &QryInvestorPositionCombineDetailField::setInvestUnitID);
	...
	class_<TradingNoticeInfoField>("TradingNoticeInfoField")
		...
		.add_property("investUnitID", &TradingNoticeInfoField::getInvestUnitID, &TradingNoticeInfoField::setInvestUnitID);
	...
	class_<TradingNoticeField>("TradingNoticeField")
		...
		.add_property("investUnitID", &TradingNoticeField::getInvestUnitID, &TradingNoticeField::setInvestUnitID);
	...
	class_<QryTradingNoticeField>("QryTradingNoticeField")
		...
		.add_property("investUnitID", &QryTradingNoticeField::getInvestUnitID, &QryTradingNoticeField::setInvestUnitID);
	...
	class_<QryBrokerTradingParamsField>("QryBrokerTradingParamsField")
		...
		.add_property("accountID", &QryBrokerTradingParamsField::getAccountID, &QryBrokerTradingParamsField::setAccountID);
	...
	class_<BrokerTradingParamsField>("BrokerTradingParamsField")
		...
		.add_property("accountID", &BrokerTradingParamsField::getAccountID, &BrokerTradingParamsField::setAccountID);
	...
	class_<EWarrantOffsetField>("EWarrantOffsetField")
		...
		.add_property("investUnitID", &EWarrantOffsetField::getInvestUnitID, &EWarrantOffsetField::setInvestUnitID);
	...
	class_<QryEWarrantOffsetField>("QryEWarrantOffsetField")
		...
		.add_property("investUnitID", &QryEWarrantOffsetField::getInvestUnitID, &QryEWarrantOffsetField::setInvestUnitID);
	...
	class_<QryInvestorProductGroupMarginField>("QryInvestorProductGroupMarginField")
		...
		.add_property("exchangeID", &QryInvestorProductGroupMarginField::getExchangeID, &QryInvestorProductGroupMarginField::setExchangeID)
		.add_property("investUnitID", &QryInvestorProductGroupMarginField::getInvestUnitID, &QryInvestorProductGroupMarginField::setInvestUnitID);
	...
	class_<InvestorProductGroupMarginField>("InvestorProductGroupMarginField")
		...
		.add_property("exchangeID", &InvestorProductGroupMarginField::getExchangeID, &InvestorProductGroupMarginField::setExchangeID)
		.add_property("investUnitID", &InvestorProductGroupMarginField::getInvestUnitID, &InvestorProductGroupMarginField::setInvestUnitID);
	...
	class_<QueryCFMMCTradingAccountTokenField>("QueryCFMMCTradingAccountTokenField")
		...
		.add_property("investUnitID", &QueryCFMMCTradingAccountTokenField::getInvestUnitID, &QueryCFMMCTradingAccountTokenField::setInvestUnitID);
	...
	class_<QrySecAgentCheckModeField>("QrySecAgentCheckModeField")
		.add_property("brokerID", &QrySecAgentCheckModeField::getBrokerID, &QrySecAgentCheckModeField::setBrokerID)
		.add_property("investorID", &QrySecAgentCheckModeField::getInvestorID, &QrySecAgentCheckModeField::setInvestorID);

	class_<QrySecAgentTradeInfoField>("QrySecAgentTradeInfoField")
		.add_property("brokerID", &QrySecAgentTradeInfoField::getBrokerID, &QrySecAgentTradeInfoField::setBrokerID)
		.add_property("brokerSecAgentID", &QrySecAgentTradeInfoField::getBrokerSecAgentID, &QrySecAgentTradeInfoField::setBrokerSecAgentID);

	class_<UserSystemInfoField>("UserSystemInfoField")
		.add_property("brokerID", &UserSystemInfoField::getBrokerID, &UserSystemInfoField::setBrokerID)
		.add_property("userID", &UserSystemInfoField::getUserID, &UserSystemInfoField::setUserID)
		.def_readwrite("clientSystemInfoLen", &UserSystemInfoField::ClientSystemInfoLen)
		.add_property("clientSystemInfo", &UserSystemInfoField::getClientSystemInfo, &UserSystemInfoField::setClientSystemInfo)
		.add_property("clientPublicIP", &UserSystemInfoField::getClientPublicIP, &UserSystemInfoField::setClientPublicIP)
		.def_readwrite("clientIPPort", &UserSystemInfoField::ClientIPPort)
		.add_property("clientLoginTime", &UserSystemInfoField::getClientLoginTime, &UserSystemInfoField::setClientLoginTime)
		.add_property("clientAppID", &UserSystemInfoField::getClientAppID, &UserSystemInfoField::setClientAppID);

	class_<ReqUserAuthMethodField>("ReqUserAuthMethodField")
		.add_property("tradingDay", &ReqUserAuthMethodField::getTradingDay, &ReqUserAuthMethodField::setTradingDay)
		.add_property("brokerID", &ReqUserAuthMethodField::getBrokerID, &ReqUserAuthMethodField::setBrokerID)
		.add_property("userID", &ReqUserAuthMethodField::getUserID, &ReqUserAuthMethodField::setUserID);

	class_<RspUserAuthMethodField>("RspUserAuthMethodField")
		.def_readwrite("usableAuthMethod", &RspUserAuthMethodField::UsableAuthMethod);

	class_<ReqGenUserCaptchaField>("ReqGenUserCaptchaField")
		.add_property("tradingDay", &ReqGenUserCaptchaField::getTradingDay, &ReqGenUserCaptchaField::setTradingDay)
		.add_property("brokerID", &ReqGenUserCaptchaField::getBrokerID, &ReqGenUserCaptchaField::setBrokerID)
		.add_property("userID", &ReqGenUserCaptchaField::getUserID, &ReqGenUserCaptchaField::setUserID);

	class_<RspGenUserCaptchaField>("RspGenUserCaptchaField")
		.add_property("brokerID", &RspGenUserCaptchaField::getBrokerID, &RspGenUserCaptchaField::setBrokerID)
		.add_property("userID", &RspGenUserCaptchaField::getUserID, &RspGenUserCaptchaField::setUserID)
		.def_readwrite("captchaInfoLen", &RspGenUserCaptchaField::CaptchaInfoLen)
		.add_property("captchaInfo", &RspGenUserCaptchaField::getCaptchaInfo, &RspGenUserCaptchaField::setCaptchaInfo);

	class_<ReqGenUserTextField>("ReqGenUserTextField")
		.add_property("tradingDay", &ReqGenUserTextField::getTradingDay, &ReqGenUserTextField::setTradingDay)
		.add_property("brokerID", &ReqGenUserTextField::getBrokerID, &ReqGenUserTextField::setBrokerID)
		.add_property("userID", &ReqGenUserTextField::getUserID, &ReqGenUserTextField::setUserID);

	class_<RspGenUserTextField>("RspGenUserTextField")
		.def_readwrite("userTextSeq", &RspGenUserTextField::UserTextSeq);

	class_<ReqUserLoginWithCaptchaField>("ReqUserLoginWithCaptchaField")
		.add_property("tradingDay", &ReqUserLoginWithCaptchaField::getTradingDay, &ReqUserLoginWithCaptchaField::setTradingDay)
		.add_property("brokerID", &ReqUserLoginWithCaptchaField::getBrokerID, &ReqUserLoginWithCaptchaField::setBrokerID)
		.add_property("userID", &ReqUserLoginWithCaptchaField::getUserID, &ReqUserLoginWithCaptchaField::setUserID)
		.add_property("password", &ReqUserLoginWithCaptchaField::getPassword, &ReqUserLoginWithCaptchaField::setPassword)
		.add_property("userProductInfo", &ReqUserLoginWithCaptchaField::getUserProductInfo, &ReqUserLoginWithCaptchaField::setUserProductInfo)
		.add_property("interfaceProductInfo", &ReqUserLoginWithCaptchaField::getInterfaceProductInfo, &ReqUserLoginWithCaptchaField::setInterfaceProductInfo)
		.add_property("protocolInfo", &ReqUserLoginWithCaptchaField::getProtocolInfo, &ReqUserLoginWithCaptchaField::setProtocolInfo)
		.add_property("macAddress", &ReqUserLoginWithCaptchaField::getMacAddress, &ReqUserLoginWithCaptchaField::setMacAddress)
		.add_property("clientIPAddress", &ReqUserLoginWithCaptchaField::getClientIPAddress, &ReqUserLoginWithCaptchaField::setClientIPAddress)
		.add_property("loginRemark", &ReqUserLoginWithCaptchaField::getLoginRemark, &ReqUserLoginWithCaptchaField::setLoginRemark)
		.add_property("captcha", &ReqUserLoginWithCaptchaField::getCaptcha, &ReqUserLoginWithCaptchaField::setCaptcha)
		.def_readwrite("clientIPPort", &ReqUserLoginWithCaptchaField::ClientIPPort);

	class_<ReqUserLoginWithTextField>("ReqUserLoginWithTextField")
		.add_property("tradingDay", &ReqUserLoginWithTextField::getTradingDay, &ReqUserLoginWithTextField::setTradingDay)
		.add_property("brokerID", &ReqUserLoginWithTextField::getBrokerID, &ReqUserLoginWithTextField::setBrokerID)
		.add_property("userID", &ReqUserLoginWithTextField::getUserID, &ReqUserLoginWithTextField::setUserID)
		.add_property("password", &ReqUserLoginWithTextField::getPassword, &ReqUserLoginWithTextField::setPassword)
		.add_property("userProductInfo", &ReqUserLoginWithTextField::getUserProductInfo, &ReqUserLoginWithTextField::setUserProductInfo)
		.add_property("interfaceProductInfo", &ReqUserLoginWithTextField::getInterfaceProductInfo, &ReqUserLoginWithTextField::setInterfaceProductInfo)
		.add_property("protocolInfo", &ReqUserLoginWithTextField::getProtocolInfo, &ReqUserLoginWithTextField::setProtocolInfo)
		.add_property("macAddress", &ReqUserLoginWithTextField::getMacAddress, &ReqUserLoginWithTextField::setMacAddress)
		.add_property("clientIPAddress", &ReqUserLoginWithTextField::getClientIPAddress, &ReqUserLoginWithTextField::setClientIPAddress)
		.add_property("loginRemark", &ReqUserLoginWithTextField::getLoginRemark, &ReqUserLoginWithTextField::setLoginRemark)
		.add_property("text", &ReqUserLoginWithTextField::getText, &ReqUserLoginWithTextField::setText)
		.def_readwrite("clientIPPort", &ReqUserLoginWithTextField::ClientIPPort);

	class_<ReqUserLoginWithOTPField>("ReqUserLoginWithOTPField")
		.add_property("tradingDay", &ReqUserLoginWithOTPField::getTradingDay, &ReqUserLoginWithOTPField::setTradingDay)
		.add_property("brokerID", &ReqUserLoginWithOTPField::getBrokerID, &ReqUserLoginWithOTPField::setBrokerID)
		.add_property("userID", &ReqUserLoginWithOTPField::getUserID, &ReqUserLoginWithOTPField::setUserID)
		.add_property("password", &ReqUserLoginWithOTPField::getPassword, &ReqUserLoginWithOTPField::setPassword)
		.add_property("userProductInfo", &ReqUserLoginWithOTPField::getUserProductInfo, &ReqUserLoginWithOTPField::setUserProductInfo)
		.add_property("interfaceProductInfo", &ReqUserLoginWithOTPField::getInterfaceProductInfo, &ReqUserLoginWithOTPField::setInterfaceProductInfo)
		.add_property("protocolInfo", &ReqUserLoginWithOTPField::getProtocolInfo, &ReqUserLoginWithOTPField::setProtocolInfo)
		.add_property("macAddress", &ReqUserLoginWithOTPField::getMacAddress, &ReqUserLoginWithOTPField::setMacAddress)
		.add_property("clientIPAddress", &ReqUserLoginWithOTPField::getClientIPAddress, &ReqUserLoginWithOTPField::setClientIPAddress)
		.add_property("loginRemark", &ReqUserLoginWithOTPField::getLoginRemark, &ReqUserLoginWithOTPField::setLoginRemark)
		.add_property("OTPPassword", &ReqUserLoginWithOTPField::getOTPPassword, &ReqUserLoginWithOTPField::setOTPPassword)
		.def_readwrite("clientIPPort", &ReqUserLoginWithOTPField::ClientIPPort); 

...
class PositionState(object):
    ...
    def exit(self, position, stopPrice=None, limitPrice=None, goodTillCanceled=None,onOpposite=None):
        raise NotImplementedError()
...
class OpenState(PositionState):
    ...
    def exit(self, position, stopPrice=None, limitPrice=None, goodTillCanceled=None,onOpposite=None):
        ...
        position._submitExitOrder(stopPrice, limitPrice, goodTillCanceled,onOpposite)
...
class Position(object):
    ...
    def exitMarket(self, goodTillCanceled=None,onOpposite=None):
        ...
        self.__state.exit(self, None, None, goodTillCanceled,onOpposite)
    ...
    def _submitExitOrder(self, stopPrice, limitPrice, goodTillCanceled,onOpposite):
        assert(not self.exitActive())

        exitOrder = self.buildExitOrder(stopPrice, limitPrice,onOpposite)
    ...
    def buildExitOrder(self, stopPrice, limitPrice,onOpposite):
        raise NotImplementedError()
...
class LongPosition(Position):
    def __init__(self, strategy, instrument, stopPrice, limitPrice, quantity, goodTillCanceled, allOrNone,onOpposite):
        if limitPrice is None and stopPrice is None:
            entryOrder = strategy.getBroker().createMarketOrder(broker.Order.Action.BUY, instrument, quantity, onOpposite)
    ...
    def buildExitOrder(self, stopPrice, limitPrice,onOpposite):
        ...
        assert(quantity > 0)
        if limitPrice is None and stopPrice is None:
            ret = self.getStrategy().getBroker().createMarketOrder(broker.Order.Action.SELL, self.getInstrument(), quantity, onOpposite)
        elif limitPrice is not None and stopPrice is None:
...
class ShortPosition(Position):
    def __init__(self, strategy, instrument, stopPrice, limitPrice, quantity, goodTillCanceled, allOrNone,onOpposite):
        if limitPrice is None and stopPrice is None:
            entryOrder = strategy.getBroker().createMarketOrder(broker.Order.Action.SELL_SHORT, instrument, quantity, onOpposite)
        elif limitPrice is not None and stopPrice is None:
    ...
    def buildExitOrder(self, stopPrice, limitPrice,onOpposite):
        ...
        assert(quantity > 0)
        if limitPrice is None and stopPrice is None:
            ret = self.getStrategy().getBroker().createMarketOrder(broker.Order.Action.BUY_TO_COVER, self.getInstrument(), quantity, onOpposite)
        elif limitPrice is not None and stopPrice is None:
